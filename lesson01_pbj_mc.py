...
if bread >= 2 and pb >= 1 and jelly >= 1:
	print "I can make at least 1 pb and j sandwich!"
else: 
	print "Looks like I don't have enough ingredients to make even 1 sandwich. Sad."
...
bread = bread/2
# MC COMMENTS: took me FOREVER to get that I just needed to divide "bread" by 2. UGH. 
#     Second, didn't make the .format() connection. If you put the lowest value variable in, that = the number of sandwiches you make.
#     I have to re-tool my brain to think mathematically. > < all those things make a big difference in succinct code snippets.

if bread < pb and bread < jelly:
	print "I can make {0} sandwiches and will be out of bread first.".format(bread)
elif bread < pb and bread > jelly:
	print "I can make {0} sandwiches and will be out of jelly first.".format(jelly)
else:
	print "I can make {0} sandwiches and will be out of pb first.".format(pb)
